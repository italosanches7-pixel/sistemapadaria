    ...
    <header className="border-b border-neutral-200 bg-white">
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-3 px-4 py-3">
        <div className="flex flex-wrap items-center gap-4">
          <span className="text-lg font-semibold text-amber-800">🥖 Padaria</span>
          <nav className="flex gap-3 text-sm font-medium text-neutral-600">
            <Link href="/caixa" className="hover:text-amber-800">
              Caixa
            </Link>
            <Link href="/relatorios" className="hover:text-amber-800">
              Relatórios
            </Link>
            {papel === "ADMIN" && (
              <>
                <Link href="/admin/produtos" className="hover:text-amber-800">
                  Produtos
                </Link>
                <Link href="/admin/usuarios" className="hover:text-amber-800">
                  Usuários
                </Link>
                <Link href="/admin/vendas" className="hover:text-amber-800">
                  Histórico
                </Link>
              </>
            )}
